...
import { View, Text, StyleSheet, SectionList, FlatList, useWindowDimensions, Image, TouchableOpacity } from 'react-native';
...
const PhotoGrid: React.FC<PhotoGridProps> = ({ 
  ...
  const renderSectionContent = ({ item, section }: { item: Photo, section: PhotoSection }) => {
