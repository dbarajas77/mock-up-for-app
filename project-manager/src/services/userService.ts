...
export const getUsers = async (): Promise<User[]> => {
  try {
    ...
    console.log('UserService.getUsers: Raw response:', { usersData, usersError });
    ...
    console.log('UserService.getUsers: First user data:', usersData[0]);
    ...
    if (transformedUsers.length > 0) {
      console.log('UserService.getUsers: First transformed user:', transformedUsers[0]);
    }
