...
const DocumentsScreen = () => {
  ...
  // Fetch documents on mount or when projectId changes
  useEffect(() => {
    console.log('Documents Screen: projectId changed to:', projectId);
    fetchDocuments();
  }, [projectId, route.params?.timestamp]);
    ...
    <ContentWrapper>
      <Header 
        ...
        rightButtons={projectId ? (
          ...
          >
            <Feather name="upload" size={24} color="#4a6ee0" />
          </TouchableOpacity>
        ) : null}
      />
